-- Sensor offline: notifica dono e funcionários aprovados se a última
-- leitura do galpão tem 5 minutos ou mais. Dedupa pelo id da última leitura.
-- Rode no SQL Editor se o projeto já existia. Também está no extras.sql.
